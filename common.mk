...
# This file is a manet-local product configuration snapshot of sm8650-common.
# Keep common resource paths explicit while manet owns all proprietary blobs.
LOCAL_PATH := device/xiaomi/sm8650-common

# Call manet's self-contained proprietary setup.
